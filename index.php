                            ...
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <li>
                                            <strong>URL:</strong>
                                            <a herf=" <?php echo $registros["url"];?>"><?php echo $registros["url"];?></a>
                                        </li>
                                    </ul>
        ...
        <section class="page-section bg-light" id="team">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted"><?php echo $lista_configuraciones[10]['valor']; ?></h3>
                </div>
                <div class="row">
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-start">Copyright &copy; Copyright: Proyecto_Uneweb</div>
